...
#' value, this will be fixed and only `trials` will be varied. If using a length-2 effect size with [`eval_design_mc()`][skpr::eval_design_mc] (such as
#' a binomial probability interval), the effect size pairs can be input as entries in a list.
#' @param candidateset Default `NULL`. The candidate set (see [`gen_design()`][skpr::gen_design] documentation for more information). Provided to aid code completion: can also
#' be provided in `gen_args`.
#' @param model Default `NULL`. The model (see [`gen_design()`][skpr::gen_design] and [`eval_design()`][skpr::eval_design] documentation for more information). Provided to aid code completion: can also
#' be provided in `gen_args`/`eval_args`.
#' @param alpha Default `0.05`. The allowable Type-I error rate (see [`eval_design()`][skpr::eval_design] documentation for more information). Provided to aid code completion: can also
#' be provided in `eval_args`.
#' @param gen_args Default `list()`. A list of argument/value pairs to specify the design generation parameters for [`gen_design()`][skpr::gen_design].
#' @param eval_function Default `"eval_design"`. A string (or function) specifying the skpr power evaluation function
#' (e.g. [`eval_design()`][skpr::eval_design], [`eval_design_mc()`][skpr::eval_design_mc], [`eval_design_survival_mc()`][skpr::eval_design_survival_mc], or [`eval_design_custom_mc()`][skpr::eval_design_custom_mc]).
...
#'
#'@description Gets the warnings and errors from [`calculate_power_curves()`][skpr::calculate_power_curves] output.
#'
#'@param power_curve The output from [`calculate_power_curves()`][skpr::calculate_power_curves]
