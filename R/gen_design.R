...
#'@param contrasts Default [`contr.simplex()`][skpr::contr.simplex], an orthonormal sum contrast. Function used to generate the encoding for categorical variables.
...
#'information in its attributes, which can be accessed with the [`get_attribute()`][skpr::get_attribute] and [`get_optimality()`][skpr::get_optimality] functions.
#'@import doRNG future
#'@export
#'@details
