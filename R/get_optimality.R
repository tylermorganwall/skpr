...
#'
#'Note: The choice of contrast will effect the `G` efficiency value, and [`gen_design()`][skpr::gen_design]
#'and [`eval_design()`][skpr::eval_design] by default set different contrasts ([`contr.simplex()`][skpr::contr.simplex] vs `contr.sum`).
#'
