...
skprGUI = function(
  ...
  server = function(input, output, session) {
    ...
    code_reactives = create_code_pane_reactives(
      input = input,
      update = update,
      candidatesetall = candidatesetall,
      any_htc_fn = function() any_htc()
    )
    inputstring = code_reactives$inputstring
    isblockingtext = code_reactives$isblockingtext
    modelwithblocks = code_reactives$modelwithblocks
    contraststring = code_reactives$contraststring
    anyfactors = code_reactives$anyfactors
    regularmodelstring = code_reactives$regularmodelstring
