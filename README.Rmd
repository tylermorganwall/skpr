...
In addition, the package offers two functions to generate common plots related to designs:
...
`skprGUI()` provides a graphical user interface to access all of the main features of skpr. An interactive tutorial is provided to familiarize the user with the available functionality. Type `skprGUI()` to begin. Screenshots:
...
```{r coordinate-exchange-example, eval = FALSE}
