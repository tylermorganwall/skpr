# skpr ![](reference/figures/skprlogo.png)

![](reference/figures/vidguigif.gif)
...
- [`gen_design()`](https://tylermorganwall.github.io/skpr/reference/gen_design.md)
  generates optimal designs from a candidate set, given a model and the
  desired number of runs.
- [`eval_design()`](https://tylermorganwall.github.io/skpr/reference/eval_design.md)
  evaluates power parametrically for linear models, for normal and
  split-plot designs.
- [`eval_design_mc()`](https://tylermorganwall.github.io/skpr/reference/eval_design_mc.md)
  evaluates power with a Monte Carlo simulation, for linear and
  generalized linear models. This function also supports calculating
  power for split-plot designs using REML.
- [`eval_design_survival_mc()`](https://tylermorganwall.github.io/skpr/reference/eval_design_survival_mc.md)
  evaluates power with a Monte Carlo simulation, allowing the user to
  specify a point at which the data is censored.
- [`eval_design_custom_mc()`](https://tylermorganwall.github.io/skpr/reference/eval_design_custom_mc.md)
  allows the user to import their own libraries and use the Monte Carlo
  framework provided by skpr to calculate power.
- [`calculate_power_curves()`](https://tylermorganwall.github.io/skpr/reference/calculate_power_curves.md)
  provides an interface to automate the generation and evaluation of
  designs to create power versus sample size and effect size curves.
- [`skprGUI()`](https://tylermorganwall.github.io/skpr/reference/skprGUI.md)
  opens up the GUI in either RStudio or an external browser.

If addition, the package offers two functions to generate common plots
related to designs:

- [`plot_correlations()`](https://tylermorganwall.github.io/skpr/reference/plot_correlations.md)
  generates a color map of correlations between variables.
...
of skpr. An interactive tutorial is provided to familiarize the user
with the available functionality. Type
[`skprGUI()`](https://tylermorganwall.github.io/skpr/reference/skprGUI.md)
to begin. Screenshots:

![](reference/figures/skprGUIcomp.png)
