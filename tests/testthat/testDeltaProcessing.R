...
test_that("providing anticoef and effectsize to eval_design_survival_mc produces a warning", {
  des = expand.grid(x = c(-1, 1), y = 10:11)
  expect_warning(eval_design_survival_mc(
    des,
    ~.,
    effectsize = 2,
    anticoef = c(1, 1, 1),
...
test_that("exponential coefficient generation rejects invalid parameters", {
  ...
  #negative
  expect_error(
    skpr:::gen_exponential_anticoef(acoef, -0.5, -0.3),
  ...
  expect_error(
    skpr:::gen_exponential_anticoef(acoef, -0.3, -0.5),
    "Exponential anticipated coefficients generation error:"
  )
  expect_error(
    skpr:::gen_exponential_anticoef(acoef, -0.3, 0.5),
...
test_that("poisson coefficient generation rejects invalid parameters", {
  ...
  #negative
  expect_error(
    skpr:::gen_poisson_anticoef(acoef, -0.5, -0.3),
  ...
  expect_error(
    skpr:::gen_poisson_anticoef(acoef, -0.3, -0.5),
    "anticipated coefficients generation error:"
  )
  expect_error(
    skpr:::gen_poisson_anticoef(acoef, -0.3, 0.5),
...
test_that("eval_design_mc processes effectsize properly for glm", {
  ...
  expect_equal(
    res5$anticoef,
    c(NA, NA, NA, skpr:::gen_binomial_anticoef(c(1, 1, 1), 0.6, 0.8))
  )
  ...
  expect_equal(
    res6$anticoef,
    c(NA, NA, NA, skpr:::gen_exponential_anticoef(c(1, 1, 1), 3, 5))
  )
  ...
  expect_equal(
    res7$anticoef,
    c(NA, NA, NA, skpr:::gen_poisson_anticoef(c(1, 1, 1), 5.2, 8.3))
  )
...
test_that("eval_design_mc processes effectsize properly for glm without effect power", {
  ...
  expect_equal(
    res5$anticoef,
    skpr:::gen_binomial_anticoef(c(1, 1, 1), 0.6, 0.8)
  )
...
test_that("eval_design_survival_mc processes effectsize properly", {
  ...
  expect_equal(
    res5$anticoef,
    skpr:::gen_exponential_anticoef(c(1, 1, 1), 1, 5),
    tolerance = 1e-8
  )

  expect_silent(
    res6 <- eval_design_survival_mc(
      des,
      ~.,
      distribution = "exponential",
      effectsize = c(4, 7.3),
  ...
  expect_equal(
    res6$anticoef,
    skpr:::gen_exponential_anticoef(c(1, 1, 1), 4, 7.3),
    tolerance = 1e-8
  )
})
